          ...
          return (
            <motion.div
              ...
              whileHover={{ 
                y: -8, 
                scale: 1.005,
                boxShadow: '0 0 50px -10px rgba(56, 189, 248, 0.45), inset 0 0 20px rgba(255,255,255,0.02)'
              }}
              className="glass rounded-3xl p-6 sm:p-8 overflow-hidden transition-all duration-300 border border-white/10 relative group w-full"
            >
              <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1.8fr] gap-8 items-stretch">
                
                {/* Left Column: Banner */}
                <div className="relative aspect-video lg:aspect-auto lg:h-full rounded-2xl overflow-hidden bg-void-950/80 border border-white/5 group">
                  <ProjectBanner 
                    repoName={project.repoName} 
                    title={project.title} 
                    stack={project.stack} 
                  ...
                  <div className="absolute top-3 left-3 flex gap-2 z-10">
                    <span className="px-2.5 py-1 rounded-full text-[10px] tracking-wider uppercase font-semibold border border-white/10 bg-slate-900/85 backdrop-blur-md text-slate-300">
                      {project.category}
                    </span>
                    <span className={`px-2.5 py-1 rounded-full text-[10px] tracking-wider uppercase font-semibold border ${
                ...
                <div className="flex flex-col justify-between">
                  <div>
                    <h3 className="font-display font-bold text-2xl sm:text-3xl text-slate-100 group-hover:text-primary transition-colors duration-300">
                      {project.title}
                    </h3>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.stack.map((tech) => (
                          <motion.span
                            ...
                            className="inline-flex items-center text-xs font-semibold px-3 py-1 rounded-full border border-white/10 bg-slate-900/60 text-slate-200"
                          >
                            <TechLogo tech={tech} />
                            {tech}
                          </motion.span>
                    ...
                    <div className="mt-6 border-t border-white/10 pt-5">
                      <p className="text-xs uppercase tracking-wider text-slate-400 font-semibold mb-3 flex items-center gap-1.5">
                        <Github size={14} className="text-slate-400" /> GitHub Repository Statistics
                      </p>
                      ...
                      {loading ? (
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
                          ...
                          <div className="glass-strong rounded-xl p-2.5 text-center border border-white/5">
                            ...
                            <p className="font-display font-semibold text-slate-200 text-sm truncate" title={githubData[project.repoName]?.license || 'None'}>
                      ...
                      {!loading && githubData[project.repoName]?.lastUpdated && (
                        <p className="text-[10px] text-slate-500 mt-2.5 text-right italic">
                      ...
                      <>
                        {homepageUrl && (
                          <motion.a
                            ...
                            whileTap={{ scale: 0.98 }}
                            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-primary to-accent text-slate-950 text-sm font-semibold hover:shadow-glow transition-shadow duration-300"
                          >
                        ...
                        <motion.a
                          ...
                          whileHover={{ scale: 1.02 }}
                          whileTap={{ scale: 0.98 }}
                          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-white/10 bg-white/[0.03] hover:border-primary/40 hover:bg-primary/10 text-slate-200 text-sm font-semibold transition-all duration-300"
                        >
                          <Github size={16} />
                          View Repository
                        </motion.a>
                        <motion.a
                          ...
                          whileHover={{ scale: 1.02 }}
                          whileTap={{ scale: 0.98 }}
                          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-white/10 bg-slate-900/40 hover:border-accent/40 hover:bg-accent/10 text-slate-300 text-sm font-semibold transition-all duration-300"
                        >
                          <BookOpen size={16} />
                          Read Documentation
                        </motion.a>
